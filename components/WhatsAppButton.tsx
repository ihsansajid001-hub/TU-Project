...
export function WhatsAppButton() {
  ...
  const message = "Hi Team United! I'd like to learn more about your initiatives.";
  ...
  return (
    ...
    >
      ...
      >
        {/* Main button - WhatsApp Brand Green */}
        <div className="relative w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center group-hover:shadow-xl transition-all">
          {/* WhatsApp Icon */}
          <svg
            viewBox="0 0 24 24"
